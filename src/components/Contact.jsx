...
const Contact = () => {
  ...
  return (
    // Added 'bg-glow' class for the subtle background lighting effect
    <div className="min-h-screen bg-gray-900 antialiased bg-glow">
      <style>{`
      ...
      <div className="py-16 md:py-24 lg:py-32" id="contact">
