...
const ServicesSection = () => {
  ...
  const ServiceCardSkeleton = () => (
    <div className="relative block rounded-xl cursor-pointer animate-pulse">
      {/* Skeleton Glowing Border Layer */}
      <div className="absolute -inset-0.5 rounded-xl bg-gray-800/50"></div>
      
      {/* Skeleton Main Card Content */}
      <div className="relative h-full p-8 rounded-xl bg-gray-900/70 backdrop-blur-sm border border-gray-700/50 shadow-2xl shadow-gray-900/50">
        {/* Skeleton Icon Container */}
        <div className="rounded-xl inline-flex p-4 bg-gray-800 ring-4 ring-gray-900/80">
  ...
  const HeaderSkeleton = () => (
    <div className="text-center animate-pulse">
      ...
      <div className="space-y-4">
        ...
        <div className="h-12 bg-gray-700 rounded-lg w-80 mx-auto"></div>
      </div>
      
      {/* Description Skeleton */}
      <div className="max-w-4xl mt-6 mx-auto space-y-2">
        <div className="h-4 bg-gray-700 rounded w-full"></div>
  ...
  const ServiceCard = ({ service }) => {
    return (
      <div 
        key={service.id}
        className="relative block group hover:z-20 transform hover:-translate-y-2 transition-transform duration-500 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-purple-500 focus-visible:ring-offset-black rounded-xl cursor-pointer"
      >
  ...
  return (
    // ADDED ID="services" HERE for navbar access
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 relative z-10">
        ...
        {isLoading ? (
          ...
          <div className="text-center">
            ...
            <p className="max-w-4xl mt-6 mx-auto text-xl text-gray-300">
